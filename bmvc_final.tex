...
Localization is an ability of a robot to know it's position and orientation with sensors.
...
Fig.\ref{fig:localization} shows localization simulation results using histogram filter ans particle filter.
